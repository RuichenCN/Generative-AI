...
# Step 2: Evaluate the LLM's answer to the user with a rubric based on the extracted product information
cust_prod_info = {
...
# Step 3: Evaluate the LLM's answer to the user based on an ideal / exper answer (human generated) answer.
...
# Test Case 1: compare normal assistant answer and ideal / exper answer
eval1 = eval_vs_ideal(test_set_ideal, assistant_answer)
print("The result of first comparaison is\n" + eval1)

# Test Case 2: compare abnormal assistant answer and ideal / exper answer
# Abnormal assistant answer
assistant_answer_2 = "life is like a box of chocolates"
eval2 = eval_vs_ideal(test_set_ideal, assistant_answer_2)
print("The result of second comparaison is\n" + eval2)